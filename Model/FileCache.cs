...
namespace ArtPop
{
    ...
    public class FileCache
    {
        ...
        public void Search(string dir, ImageSizeFilter filter, Action objCompletionAction = null)
        {
        ...
        private void FilterWidthHeight(List<string> lstFiles, ImageSizeFilter minimax)
        {
            //This isn't thread safe.
            //Inside of this current thread we spin off 12 baby threads to carry out reading the image sizes.
            TotalWHFiltered = 0;
